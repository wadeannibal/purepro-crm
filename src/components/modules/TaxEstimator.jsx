...
export default function TaxEstimator() {
  ...
  // SE tax calculation
  const netProfit = Math.max(0, paidRevenue - parseFloat(bizExpenses || 0))
  const netSEIncome = netProfit * 0.9235
      ...
      <div className="max-w-2xl mx-auto p-3 md:p-6 space-y-6">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-5 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-600 mb-1.5">Deductible Business Expenses (optional)</label>
              <input type="number" value={bizExpenses} onChange={e => setBizExpenses(e.target.value)} placeholder="Materials, subs, supplies, etc." className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500" />
              <div className="text-xs text-gray-400 mt-0.5">Subtracted from revenue before SE tax</div>
            </div>
            <div>
